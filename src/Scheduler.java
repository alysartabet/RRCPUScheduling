...
public class Scheduler {
    ...
    /**
     * The Scheduler implements the Round Robin scheduling algorithm.
    ...
    public static Metrics roundRobin(ArrayList<Process> processList, int timeQuantum) {
        ...
        ArrayList<Process> processes = new ArrayList<>(processList); //Cloned so as not to modify the original list

        //Keep track of processes that have been added to the ready queue
        ...
        //Context switch time (assuming a fixed value, such as 1 unit of time)
